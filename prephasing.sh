...
prephase(){
	...
	plink --bfile $data --exclude $prefix/Exclude-$data-1000G.txt --make-bed --out $prefix/TEMP1
	plink --bfile TEMP1 --update-map $prefix/Chromosome-$data-1000G.txt --update-chr --make-bed --out $prefix/TEMP2
	plink --bfile TEMP2 --update-map $prefix/Position-$data-1000G.txt --make-bed --out $prefix/TEMP3
	plink --bfile TEMP3 --flip $prefix/Strand-Flip-$data-1000G.txt --make-bed --out $prefix/TEMP4
	plink --bfile TEMP4 --reference-allele $prefix/Force-Allele1-$data-1000G.txt --make-bed --out prephasing_files/${data}_updated
